...
public static class Accessory
{
    ...
    public static string CheckHexString(string inStr)
    {
        ...
        for (int i = 0; i < inStr.Length; i++)
        {
            ...
            {
                for (int i1 = 0; i1 < 2 - tmpStr.Length; i1++)
                {
                    outStr.Append("0");
                }
        ...
        if (tmpStr.Length > 0)
        {
            for (int i = 0; i < 2 - tmpStr.Length; i++)
            {
                outStr.Append("0");
            }
...
public static string CheckDecString(string inStr)
{
    ...
    for (int i = 0; i < inStr.Length; i++)
    {
        ...
        {
            for (int i1 = 0; i1 < inStr.Length - tmpStr.Length; i1++)
            {
                outStr.Append("0");
            }
    ...
    if (tmpStr.Length > 0)
    {
        for (int i = 0; i < inStr.Length - tmpStr.Length; i++)
        {
            outStr.Append("0");
        }
...
public static string CheckDecString(string inStr, int length)
{
    ...
    for (int i = 0; i < inStr.Length; i++)
    {
        ...
        {
            for (int i1 = 0; i1 < length - tmpStr.Length; i1++)
            {
                outStr.Append("0");
            }
...
public static string CheckBinString(string inStr)
{
    ...
    for (var i = 0; i < inStr.Length; i++)
    {
        ...
        {
            for (int i1 = 0; i1 < 8 - tmpStr.Length; i1++)
            {
                outStr.Append("0");
            }
...
public static bool PrintableHex(string str)
{
    ...
    {
        if (!byte.TryParse(str.Substring(i, 3), NumberStyles.HexNumber, null, out byte n))
        {
            return false;
        }
...
{
    if (string.IsNullOrEmpty(expression) || variables == null || values == null)
    {
        return 0;
    }
