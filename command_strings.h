...
#define CMD_AP_PASS							F("ap_pass")
#define REPLY_AP_PASS						F("WiFi AP password")

#define CMD_AP_SSID							F("ap_ssid")
...
// Display
#define CMD_DISPLAY_REFRESH					F("display_refresh")
#define REPLY_DISPLAY_REFRESH				F("Display refresh period")

// EVENTS
#define CMD_EVENTS_ENABLE					F("events_enable")
...
#define CMD_CLEAR_SCHEDULE_EXEC_TIME		F("clear_schedule_exec_time")
...
// GScript
#define CMD_GSCRIPT_ENABLE					F("gscript_enable")
...
#define CMD_GETLOG							F("getlog")

// Test commands
#define CMD_GET_CONFIG						F("get_config")

#define CMD_GET_SENSOR						F("get_sensor")
